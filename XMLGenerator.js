	  							...
	  							.startElement('shelfSection')
	  								.startElement('items')
	  									.startElement('actionButton')
	  										...
	  										.writeAttribute('onSelect', "addUDIDtoQuery('http://trailers.apple.com/Movies/MoviePlay.xml?torrent=" + selectTorrent(movie.torrents, quality) + "&id=" + torrentID + "&title=" + movie.title.replace(/ /g,"%20").replace(/'/, '') + "&desc=" + movie.description_full.replace(/ /g,"%20").replace(/['"]+/g, '').replace(/'/, '') + "&poster=" + movie.images.medium_cover_image + '&subtitle=' + subtitle + "')")
	  						...
	  						.startElement('sections')
	  							.startElement('shelfSection')
	  								.startElement('items')
	  									.startElement('actionButton')
                                            .writeAttribute('id', 'play')
                                            .writeAttribute('onSelect', "atv.loadURL('" + encodeURI("http://trailers.apple.com/Movies/MoviePlay.xml?id=" + imdb + "&UDID=" + UDID + "&title=" + encodeURIComponent(show.title.replace(/'/, '')) + "&desc=" + encodeURIComponent(show.overview.replace(/'/, '')) + "&poster=" + show.images.screenshot.thumb + "&torrent=" + torrentURL + '&subtitle=' + subtitle) + "')")
                                            .writeElement('title', 'Play')
                                            .writeElement('image', 'resource://Play.png')
                                            .writeElement('focusedImage', 'resource://PlayFocused.png')
                                        .endElement()
